...
binary = resolve_binary_path(__file__, "sit_launch_sync_launch_sync_riscv")


register_npu_test(
    NpuRunnerSpec(
        name="megacmdqueue_launch_sync_launch_sync",
        ...
        verifier_specs=r"MEGACMDQUEUE_LAUNCH_SYNC_LAUNCH_SYNC_PASS",
