...
main(void)
{
    ...
    if (npu_wait_u32_vector_match(NULL,
        ...
        printf("VPU_ELEMWISE_ADD_I32_FAIL\n");
        npu_expect_u32_vector("VPU_ELEMWISE_ADD_I32", expected, actual,
                              ELEM_COUNT);
        return 1;
    }

    printf("VPU_ELEMWISE_ADD_I32_PASS\n");
    return 0;
}
